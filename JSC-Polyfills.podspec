#
#  Be sure to run `pod spec lint JSC-Polyfills.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/TheNoim/JSC-Polyfills"
  ...
  # spec.authors            = { "Nils Bergmann" => "email@address.com" }
  ...
  spec.prepare_command = "./build-js.sh"
